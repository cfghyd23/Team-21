...
- [Dev Deps] update `@ljharb/eslint-config`, `aud`, `error-cause` [`c4332`](https://github.com/inspect-js/object-inspect/commit/c43324b48384a16fdc444e5fc589d785bef3)
...
- [Robustness] cache more prototype methods [`19153`](https://github.com/inspect-js/object-inspect/commit/19153a8aec98a05eadd73a5a6e979c9c8653e8)
...
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `tape` [`22c8dc0`](https://github.com/inspect-js/object-inspect/commit/22c8dc0cac1170f4781e49a950070923a671be)
...
- [Dev Deps] update `eslint` [`7c4e6fd`](https://github.com/inspect-js/object-inspect/commit/7c4e6fdedcd27cc980e13c9ad834d05a96f40c)
...
- [Tests] add passing tests [`01ac3e4`](https://github.com/inspect-js/object-inspect/commit/01ac3e4b5a30f97875a6c9b1416b3bd626afc9)
...
- [Robustness] cache `Symbol.prototype.toString` [`f3c2074`](https://github.com/inspect-js/object-inspect/commit/f3c2074d8f32faf8292587c07c9678ea93170d)
...
- [actions] update rebase checkout action to v2 [`55a39a6`](https://github.com/inspect-js/object-inspect/commit/55a39a64e944f19c6a7d8efddff27700f20d14)
...
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `tape` [`1a8a5ea`](https://github.com/inspect-js/object-inspect/commit/1a8a5ea069ea2bee89d77caedad83ffa235711)
...
- [New] add support for `WeakMap` and `WeakSet` [`db3e4`](https://github.com/inspect-js/object-inspect/commit/db3e4e0c8287130c61a12e0ed9c104b1549306)
...
- [Refactor] add early bailout to `isMap` and `isSet` checks [`fc51047`](https://github.com/inspect-js/object-inspect/commit/fc5104714a3671d37e22581b79470d6335683b)
...
- [New] add support for `util.inspect.custom`, in node only. [`20cca77`](https://github.com/inspect-js/object-inspect/commit/20cca7762d7e17f15b21a9079ff84acce155df)
- [Tests] up to `node` `v8.6`; use `nvm install-latest-npm` to ensure new npm doesn’t break old node [`252952d`](https://github.com/inspect-js/object-inspect/commit/252952d230d8065851dd4d5fe8398aae068529)
- [Tests] up to `node` `v8.8` [`4aa868d`](https://github.com/inspect-js/object-inspect/commit/4aa868d3a62914091d489dd6ec6eed194ee67cd3)
- [Dev Deps] update `core-js`, `tape` [`59481`](https://github.com/inspect-js/object-inspect/commit/59481df418f852f51fa0db7b24aa6b0209a27a)
...
- [Refactor] avoid recreating `lowbyte` function every time. [`81edd34`](https://github.com/inspect-js/object-inspect/commit/81edd3475bd15bdd18e84de747203cf5004aaa)
...
- bump tape [`10674`](https://github.com/inspect-js/object-inspect/commit/1067496b504bdcfdd765d303a773f87ec106e2)
...
- passing lowbyte interpolation test [`b847511`](https://github.com/inspect-js/object-inspect/commit/b8475114f5def7e7961c53548d8d9a520985)
...
- fixes for holes [`ce25f73`](https://github.com/inspect-js/object-inspect/commit/ce25f73668e4b92ff27dc5471218415e2d78d8)
- weird null behavior [`405c1ea`](https://github.com/inspect-js/object-inspect/commit/405c1ea72cd5a8cf3b498c3eaa9001b9fbcab5)
